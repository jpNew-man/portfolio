...
$('.sec3 .work8 #computer, #space, #duck').mouseover(function(){
    $(this).children('.up').stop().animate({bottom:0});
});
$('.sec3 .work8 #computer, #space, #duck').mouseout(function(){
    $(this).children('.up').stop().animate({bottom:-120});
});


$('.work8 #computer').click(function(){
    $('#modal').css("display","block");
    $('#modal .com').css("display","block");
});
$('.work8 #space').click(function(){
    $('#modal').css("display","block");
    $('#modal .spa').css("display","block");
});
$('.work8 #duck').click(function(){
    $('#modal').css("display","block");
